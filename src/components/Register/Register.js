...
const Register = (props) => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = 'PDF Guardhouse - Signup'
  }, [])
    ...
    <div id="registerDiv">
      <div className="container pt-32" id="containerRegister">
        <h1 className="font-extrabold text-center">
          Register to <span className="sp">PDF Guardhouse </span>for <span className="text-green-500">FREE</span>
        </h1>
        <div className="card my-4" id="cardDiv">
  <div className="row no-gutters">
    <div className="col-md-12">
      <h2 className='text-center font-extrabold sp'>PDF Guardhouse</h2>
